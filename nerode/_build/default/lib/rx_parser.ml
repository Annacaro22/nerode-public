...
and ('s, 'r) _menhir_cell1_cx = 
  | MenhirCell1_cx of 's * ('s, 'r) _menhir_state * (Rx.t)

and ('s, 'r) _menhir_cell1_drx = 
  | MenhirCell1_drx of 's * ('s, 'r) _menhir_state * (Rx.t)

and ('s, 'r) _menhir_cell1_irx = 
  | MenhirCell1_irx of 's * ('s, 'r) _menhir_state * (Rx.t)

and ('s, 'r) _menhir_cell1_urx = 
  | MenhirCell1_urx of 's * ('s, 'r) _menhir_state * (Rx.t)

and ('s, 'r) _menhir_cell1_LPAR = 
  | MenhirCell1_LPAR of 's * ('s, 'r) _menhir_state

and _menhir_box_rx_eof = 
  | MenhirBox_rx_eof of (Rx.t) [@@unboxed]
...
# 43 "lib/rx_parser.mly"
      ( Rx.(union_pair (Char (Alphabet.sym_of_int 0)) (Char (Alphabet.sym_of_int 1))) )
...
include struct
  ...
  let _menhir_run_24 : type  ttv_stack. ttv_stack -> _ -> _ -> _menhir_box_rx_eof =
  ...
  let rec _menhir_run_01 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _menhir_box_rx_eof =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      let _tok = _menhir_lexer _menhir_lexbuf in
      let _v = _menhir_action_04 () in
      _menhir_goto_cx _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_goto_cx : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _ -> _menhir_box_rx_eof =
  ...
  and _menhir_run_02 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _menhir_box_rx_eof =
  ...
  and _menhir_run_04 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _menhir_box_rx_eof =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
      let _tok = _menhir_lexer _menhir_lexbuf in
  ...
  and _menhir_run_16 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _ -> _menhir_box_rx_eof =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      let r = _v in
      let _v = _menhir_action_13 r in
      _menhir_goto_rx _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_goto_rx : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_rx_eof) _menhir_state -> _ -> _menhir_box_rx_eof =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match _menhir_s with
      | MenhirState00 ->
  ...
  and _menhir_run_14 : type  ttv_stack. (ttv_stack, _menhir_box_rx_eof) _menhir_cell1_LPAR -> _ -> _ -> _ -> _ -> _menhir_box_rx_eof =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      match (_tok : MenhirBasics.token) with
      | RPAR ->
          let _tok = _menhir_lexer _menhir_lexbuf in
  ...
  let _menhir_run_00 : type  ttv_stack. ttv_stack -> _ -> _ -> _menhir_box_rx_eof =
